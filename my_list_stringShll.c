...
/**
 * my_add_nodeShll - Function that inserts
 * a node at the beginning of a linked list.
 *
...
my_list_stShll *my_add_nodeShll(my_list_stShll **my_headShll,
		 const char *my_strShll, int my_numShll)
{
...
/**
 * my_node_starts_withShll - Finds a node whose
...
my_list_stShll *my_node_starts_withShll(my_list_stShll *my_nodeShll,
		 char *my_prefixShll, char my_cShll)
{
	char *my_pShll = NULL;
...
/**
 * my_print_liststrShll - Prints only the 'str'
...
my_list_stShll *my_add_node_endShll(my_list_stShll **my_headShll,
		 const char *my_strShll, int my_numShll)
{
